	...
	export default {
		...
		methods: {
			init() {
				...
				container.addEventListener( 'touchstart', this.onDocumentTouchStart, { passive: false } );
				container.addEventListener( 'touchmove', this.onDocumentTouchMove, { passive: false } );
				//
